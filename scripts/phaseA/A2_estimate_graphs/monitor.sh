...
PROGRESS_FILE="/home/sandesh/Documents/Global_Project/v3.0/data/country_graphs/progress.json"
...
echo ""
echo "Output files:"
ls -1 /home/sandesh/Documents/Global_Project/v3.0/data/country_graphs/*.json 2>/dev/null | wc -l
